...
public class MailUtil {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String mailActiveCode) throws Exception {
    	// 创建图片
  		 ...
  		 */
  		//DataHandler dh = new DataHandler(new FileDataSource("images//Error.png"));//图片路径
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "TCODE开源论坛社区", "UTF-8"));
        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "网站用户", "UTF-8"));
        message.setRecipient(MimeMessage.RecipientType.CC,new InternetAddress(myEmailAccount, "TCODE用户信息安全部", "UTF-8"));
        // 4. Subject: 邮件主题
        message.setSubject("安全风险提醒", "UTF-8");
        String activeUrl="http://localhost:8080/tcode/safecenter.html";
        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("尊敬的用户/开发者：<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！TCODE开源论坛社区【TCODE风控系统】检测到您账号出现异地登录，为了确保安全，风控系统已将您的账号进行冻结！<br>若存在误封或疑问，您可以前往安全中心<a href="+activeUrl+" target='_blank'>"+activeUrl+"</a>进行解冻并获取帮助！", "text/html;charset=UTF-8");
        // 6. 设置发件时间

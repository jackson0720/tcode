...
//	   	   		              var index = range.index + range.length;
	   	   		            //  alert($('.ql-editor p').html());
	   	   		   
	   	   		             //$('.ql-editor p').empty();
	   	   		            _this3.quill.updateContents(new _delta2.default().retain(range.index).delete(range.length).insert({ image:"http://127.0.0.1:8089/uploads/"+ data }), _emitter2.default.sources.USER);
	   		                  fileInput.value = "";
...
//	   	   		              var index = range.index + range.length;
	   	   		            //  alert($('.ql-editor p').html());
	   	   		             ...
	   	   		             //$('.ql-editor p').empty();
	   	   		            _this3.quill.updateContents(new _delta2.default().retain(range.index).delete(range.length).insert({ image:"http://127.0.0.1:8011/upload/"+ data }), _emitter2.default.sources.USER);
	   		                  fileInput.value = "";
